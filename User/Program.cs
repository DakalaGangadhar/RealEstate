...
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(AssemblyReference).Assembly)); // Replace typeof(Program).Assembly with the assembly containing your handlers.
